...
// Modifications Copyright (c) 2024 The NeuralVirtualizer Authors
/// \file
///
...
namespace parser {
class VirtualizedVectorAllocation;
}  // namespace parser
...
class FlatBufferModel : public FlatBufferModelBase<FlatBufferModel> {
 public:
  ...
  static std::unique_ptr<FlatBufferModel> BuildFromVirtualizedFiles(
      const char* info_path, const char* params_path,
      ErrorReporter* reporter = GetDefaultErrorReporter());
